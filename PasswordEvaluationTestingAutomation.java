 ...
 * @authro Evan Hochhalter
 * 
 * @version 1.00	2022-02-25 A set of semi-automated test cases
 * @version 2.00	2024-09-22 Updated for use at ASU
 * @version 3.00	2025-02-05 New test cases added to more extensively test password evaluator
 * 
 */
public class PasswordEvaluationTestingAutomation {
	...
	public static void main(String[] args) {
		...
		performTestCase(1, "test123!", false);
		performTestCase(1, "Test1234", false);
		performTestCase(1, "TEST123!", false);
		performTestCase(1, "Test!123456789test", false);
